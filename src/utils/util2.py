...
postColorIdx = [0] + [1]*3 + [0] + [2]*3 + [0]*2 + [3]*4 + [4]*4 
...
postBones = flattenBones([initFigBone(b*4+1,3,figColor[b+1]) for b in range(2)] + [initFigBone(b*4+2,4,figColor[b+1]) for b in range(2,4)])
